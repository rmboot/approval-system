...
class Apply(db.Model):
    ...
    user = db.relationship('User', foreign_keys=[u_id])
    t_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    teacher = db.relationship('User', foreign_keys=[t_id])
    c_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    college = db.relationship('User', foreign_keys=[c_id])
    s_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    school = db.relationship('User', foreign_keys=[s_id])
